...
class RoIAlign(nn.Module):
    ...
    def __repr__(self):
        ...
        s += '(output_size={self.output_size}, '
        s += 'spatial_scale={self.spatial_scale}, '
        s += 'sampling_ratio={self.sampling_ratio}, '
        s += 'pool_mode={self.pool_mode}, '
        s += 'aligned={self.aligned}, '
        s += 'use_torchvision={self.use_torchvision})'
        return s
